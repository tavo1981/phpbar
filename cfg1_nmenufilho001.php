...
<center>
  <form action="cfg1_nmenufilho002.php" method="post" name="form1" onsubmit="return chknulo(this)">
  <table cellspacin=0>
  <tr>
    <td><b>Modulo:</b></td>
    <td>
            <? $sqlmod = "select mod_id,mod_nome from  sis_modulos order by mod_id";
                frm_select($sqlmod,"input",15,"Módulos","cbomod_id",false,"","ondblclick='form1.submit()' onClick='form1.submit()'");
                ?>
            </td>
        </tr>
        </form>
...
"<br>Confoguraçoes->Cadastrar Menu";</script>
</html> 
