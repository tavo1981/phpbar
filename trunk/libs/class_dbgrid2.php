...
class dbGrid {
     ...
     /**
     * Possibilita ou n�o redimensionar os campos
     *
     * @var boolean
     */ 
    var $resize = true;
     /**
     * Colunas do que ir�o fazer parte do grid,
    ...
    var $header;
     /**
     * Campos que  s�o padr�es no grid
     *
     * @var array
     */
    var $pfields;
      ...
      /**
     * Variavel privada da classe;guarda a descri��o do grid
     *
     * @var string
     */
    var $_table;
    ...
    var $name = "grid1";
     /**
     * Nome da fun��o a ser executa pelo grid;
     *
     * @var integer
     */
    var $js;
     /**
     * evento que sera chamado a fun��o ;
     *
     * @var string
     */
    var $event = "onClick";
     /**
     * Campos que ir�o como paremetro para a fun��o 
     *
     * @var string
     */       
    var $js_campos = "";
      /**
     * Se existe ou n�o uma fun��o a ser executa
     *
     * @var boolean
     */
    var $func      = "";
     /**
     * o grid dever� mostrar um checkbox no inicio de cada item. a valor do grid � o campo passada na variavel
     *
     * @var string
     */
    var $checkbox  = "";
    ...
    /**
     * o grid dever� mostrar um radio no inicio de cada item. a valor do grid � o campo passada na variavel
     *
     * @var string
     */
    var $radiobox  = "";
    ...
    var $rs = null;
     /**
     * o devera criar o form interno ou n�o
     *
     * @var string
     */
     var $form;    
    ...
    /**
     * Fun��o privada para gerer um Error da classe 
     *
     * @param string $msg
     */
    function _error($msg){
    ...
    /**
     * fun��o privada para testar as variaveis do cabe�alho
     *
     * @return false,true
     */
    function _testaHeader(){
        ...
        if (!is_array($this->header)){
            ...
            $this->_error("N�mero de campos do header diferente do recorset");
            return false;
        }else{
            return true;
        }
    ...
    /**
     * fun��o privada cria a descri��o do grid
     *
     */
    function _get_table(){
       ...
       if ($this->_testaHeader()){ 
           ...
           $this->_table .= "<table border='0' style='width:".$this->size."' id='".$this->name."' cellspacing=0 >";
           $this->_table .= "<tr>";
      ...
      if (pg_num_rows($rs) == 1 && $this->exec == 1){
       ...
       if ($this->limite){
           ...
           if ($pc>1) {
               $this->_table .= "<a style='text-decoration:none;color:black;cursor:pointer' 
                                 onclick=\"next($proximo,'tb".$this->name."','".str_replace("'","\'",$this->sql)."','".$this->js."','".$this->event."' ,'".$this->js_campos."',".$this->limite.")\">&#9664;&#9664;&nbsp;</a> ";
               $this->_table .=" <a style='text-decoration:none;color:black;cursor:pointer'
                                  onclick=\"next($proximo,'tb".$this->name."','".str_replace("'","\'",$this->sql)."','".$this->js."','".$this->event."' ,'".$this->js_campos."',".$this->limite.")\">&#9664;</a> ";
           }else{
           ...
           if ($pc<$tp) {
               ...
               $this->_table .=" <a style='text-decoration:none;color:black;cursor:pointer'
                                onclick=\"next($proximo,'tb".$this->name."','".str_replace("'","\'",$this->sql)."','".$this->js."','".$this->event."'
                                ,'".$this->js_campos."',".$this->limite.")\">&#9654</a>";
               $this->_table .= "&nbsp;&nbsp;<a style='text-decoration:none;color:black;cursor:pointer' 
                                  onclick=\"next($proximo,'tb".$this->name."','".str_replace("'","\'",$this->sql)."','".$this->js."','".$this->event."'
                                ,'".$this->js_campos."',".$this->limite.")\">&#9654;&#9654;</a> ";
           }else{
               $this->_table .= " <font color='#C6D099'>&#9654;";
               $this->_table .= " &#9654;&#9654;&nbsp;</font>";
           }
